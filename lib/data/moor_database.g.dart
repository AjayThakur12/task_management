...
class Task extends DataClass implements Insertable<Task> {
  ...
  Task copyWith({int id, String name, String description, int priority}) =>
      Task(
        id: id ?? this.id,
        name: name ?? this.name,
  ...
  int get hashCode => $mrjf($mrjc(id.hashCode,
      $mrjc(name.hashCode, $mrjc(description.hashCode, priority.hashCode))));
  @override
  bool operator ==(other) =>
...
class $TasksTable extends Tasks with TableInfo<$TasksTable, Task> {
  ...
  @override
  List<GeneratedColumn> get $columns => [id, name, description, priority];
  @override
